...
// TODO(mdlayher): build something to automatically populate this list.

// linkModes is a list of Ethernet link modes and their associated ethtool bit
// and string names.
var linkModes = []struct {
	...
	{
		bit: unix.ETHTOOL_LINK_MODE_10baseT_Half_BIT,
		str: "10baseT/Half",
	},
	{
		bit: unix.ETHTOOL_LINK_MODE_10baseT_Full_BIT,
		str: "10baseT/Full",
	},
	{
		bit: unix.ETHTOOL_LINK_MODE_100baseT_Half_BIT,
		str: "100baseT/Half",
	},
	{
		bit: unix.ETHTOOL_LINK_MODE_100baseT_Full_BIT,
		str: "100baseT/Full",
	},
	{
		bit: unix.ETHTOOL_LINK_MODE_1000baseT_Half_BIT,
		str: "1000baseT/Half",
	},
	{
		bit: unix.ETHTOOL_LINK_MODE_1000baseT_Full_BIT,
		str: "1000baseT/Full",
	},
	{
		bit: unix.ETHTOOL_LINK_MODE_Autoneg_BIT,
		str: "Autonegotiation",
	},
	{
		bit: unix.ETHTOOL_LINK_MODE_TP_BIT,
		str: "TwistedPair",
	},
	{
		bit: unix.ETHTOOL_LINK_MODE_AUI_BIT,
		str: "AUI",
	},
	{
		bit: unix.ETHTOOL_LINK_MODE_MII_BIT,
		str: "MII",
	},
	{
		bit: unix.ETHTOOL_LINK_MODE_FIBRE_BIT,
		str: "Fibre",
	},
	{
		bit: unix.ETHTOOL_LINK_MODE_BNC_BIT,
		str: "BNC",
	},
	{
		bit: unix.ETHTOOL_LINK_MODE_10000baseT_Full_BIT,
		str: "10000baseT/Full",
	},
	{
		bit: unix.ETHTOOL_LINK_MODE_Pause_BIT,
		str: "Pause",
	},
}
